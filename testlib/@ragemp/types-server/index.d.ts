...
declare module 'mp-server' {
	...
	type HashOrNumberOrString<T> = T | number | string;
	type HashOrString<T> = T | string;
	...
	class PlayerMp extends EntityMp {
		/**
	...
	class PlayerMpPool extends EntityMpPool<PlayerMp> {
		/**
	...
	class VehicleMp extends EntityMp {
		/**
	...
	type MultiEventHandlers = Partial<IServerEvents> & Record<string, (...args: any) => void>;

	type ThisifyServerEvents = {
	...
	class CheckpointMp extends EntityMp {
		/**
	...
	class ColshapeMp extends EntityMp {
		/**
	...
	class ColshapeMpPool extends EntityMpPool<ColshapeMp> {
		/**
	...
	class MarkerMp extends EntityMp {
		/**
		 * TODO: docs
		 */
		direction: Vector3;
	...
	class TextLabelMp extends EntityMp {
		/**
	...
	class ObjectMp extends EntityMp {
		rotation: Vector3;
